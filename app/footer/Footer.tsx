...
export default function Footer() {
  ...
  const { settings: footerSettings, loading: settingsLoading } = useFooterSettings();
    ...
    <footer className={styles.footer}>
      ...
      <div className={styles.container}>
        ...
        <div className={styles.flexContainer}>
          ...
          {/* АГЕНЦІЯ */}
          {footerSettings?.agency?.enabled !== false && (
          ...
          {/* ТОП ТЕМИ */}
          {footerSettings?.topThemes?.enabled !== false && (
            <div className={styles.column}>
              <h3 className={styles.title}>ТОП ТЕМИ</h3>
              <div className={styles.divider}></div>
              <ul className={styles.list}>
                {(orderedTopThemes.length > 0 ? orderedTopThemes : specialThemesItem).map((item) => (
                  <li key={item.id}>
          ...
          {/* КАТЕГОРІЇ */}
          {footerSettings?.categories?.enabled !== false && (
        ...
        <div className={styles.bottomSection}>
          <div>
            {/* Логотип galinfo */}
            {footerSettings?.bottomSection?.logo?.enabled !== false && (
            ...
            {/* Копірайт */}
            {footerSettings?.bottomSection?.copyright?.enabled !== false && (
            ...
            {/* Соціальні мережі */}
            {footerSettings?.bottomSection?.socialLinks?.enabled !== false && (
              <div className={styles.socialLinks}>
                {footerSettings?.bottomSection?.socialLinks?.facebook !== false && (
                ...
                {footerSettings?.bottomSection?.socialLinks?.twitter !== false && (
                ...
                {footerSettings?.bottomSection?.socialLinks?.instagram !== false && (
                ...
                {/* RSS Feed */}
                {footerSettings?.bottomSection?.socialLinks?.rss !== false && (
                  <Link 
                    href="/api/rss/export" 
                    target="_blank"
            ...
            {footerSettings?.bottomSection?.siteCreator?.enabled !== false && (
