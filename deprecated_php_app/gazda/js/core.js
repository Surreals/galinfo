...
function fblinkGet(aURL,aHeader,imURL,imText,imId){
	var fbO={
		caption     :   "Gal-Info",
	...
	var fblink="https://www.facebook.com/dialog/feed?app_id=395933437085442&caption="+fbO.caption
...
function makeViewer(oCollection,selectedAnchor){
	...
	if (!selectedAnchor)                
		...
		$(selectedAnchor).click(function(e){
			e.preventDefault();
	...
	function showInlineFrame(anchor,href){
		...
		imgPreload.onload=function(){
			...
			var fblink = fblinkGet(document.URL,articleHeader,imgPreload.src,title,imId);
			var twlink = twlinkGet(document.URL,articleHeader,imgPreload.src,title,imId);
			var vklink = vklinkGet(document.URL,articleHeader,imgPreload.src,title,imId);
