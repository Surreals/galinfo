			...
			<form name='enter' class='enter'>
				...
				<div style='margin-top:20px;'>
					...
					<div class=\"soclogin\">
						...
						<a href=\"/login/?carrier=vkontakte&authref=".$par['logtolocation']."\"><img src=\"/im/vk.png\"></a>
					</div>
...
function authOutside(){
	...
	if (!in_array($par['carrier'],array("facebook","twitter","vkontakte","google"))) $par['carrier']="facebook";
