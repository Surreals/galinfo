...
function generate_wysiwyg(textareaID,height) {
  ...
  var toolbar;
  toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><tbody id="barm"><td style="width: 6px;"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
 ...
 var sourceButton='';
  ...
  var content1 = document.getElementById(n).value;
	...
	content += '</head>\n<body id="productdescription"  class="fnormal" style="text-align:left;">'+content1+'</body>\n</html>';
